package com.example.weanimals.reporting.triage.presentation
...
import com.example.weanimals.reporting.report.presentation.sent.ReportSentActivity
...
import com.example.weanimals.reporting.triage.presenter.TriageContract
...
class TriageActivity : AppCompatActivity(), TriageContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.triageHeader.headerTitle.setText(R.string.triage_title)
        setupInteractions()
    }
    ...
    private fun setupInteractions() {
        binding.triageHeader.backButton.setOnClickListener { finish() }
